...
var category_js_1 = __importDefault(require("../models/category.js"));
// get all category
...
// add category
var addCategories = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var newCategory, saveCategory, error_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                newCategory = new category_js_1.default(req.body);
                _a.label = 1;
            case 1:
                _a.trys.push([1, 3, , 4]);
...
var deleteCategory = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 3, , 4]);
                return [4 /*yield*/, category_js_1.default.findById(req.params.id)];
            case 1:
                category = _a.sent();
                return [4 /*yield*/, (category === null || category === void 0 ? void 0 : category.delete())];
            case 2:
                _a.sent();
